        ...
        <div className="backdrop-blur-md bg-gray-900/70 border border-gray-800 rounded-xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-light text-white tracking-wider">WELCOME BACK</h2>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label htmlFor="password" className="block text-xs uppercase tracking-wide text-gray-400 font-medium">Password</label>
